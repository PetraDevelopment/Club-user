...
//   //
//   //         // Check if 'NeededGroundId' and 'GroundId' exist
//   //         var GroundIdList = userData['GroundId'];
//   //         if (GroundIdList != null) {
//   //           // Filter by 'GroundId' within 'GroundId' array
//   //
//   //             if (GroundIdList == widget.IdData) {
//   //
...
//         print("fetchbooking${selectedTimes}");
//       } else {
...
//       .where('GroundId', isEqualTo: groundIiid) // Check GroundId wit// Check any overlapping time
//           .get();
//
...
//         Map<String, dynamic> data = doc.data() as Map<String, dynamic>;
//
//         var userDataList = data['userID'];
//         var documentDate = data['dateofBooking'];
//         var selectedTimes = data['selectedTimes'] as List?;
//
//         print('Document ID: ${doc.id}');
//         print('User Data List: $userDataList');
//         print('Document Date of Booking: $documentDate');
//         print('Selected Times: $selectedTimes');
//
//         // Validate all fields
//         if (userDataList != null &&
//             userDataList.contains(userid) &&
...
//         .collection('booking').where('GroundId',isEqualTo: widget.IdData)
//
...
//     print("hujhuhuhu${existingBookings.docs.length}");
//     bool isTimeSlotBooked = false;
// print ("exisyyyyyyy${existingBookings}");
